...
<body>
	<div id="container">
		...
		<h2>Haz click en el siguiente bot&oacute;n para ir a la página, da click en "permitir" si no te redirecciona automaticamente</h2>
		<button id="btn">¡Ir a la página!</button>
	</div>
</body>
